...
namespace GeweChatHelper.Apis
{
    public class GroupApi
    {
        ...
        /// <param name="chatroomId"></param>
        /// <returns></returns>
        public  async Task<JObject> GetChatroomInfo(string appId, string chatroomId)
        {
            JObject param = new JObject();
            param["appId"] = appId;
            param["chatroomId"] = chatroomId;
            return await okhttpUtil.PostJsonAsync("/group/getChatroomInfo", param);
        }
        /// <summary>
        /// 获取群成员列表
        /// </summary>
        ...
        /// <param name="chatroomId"></param>
        /// <returns></returns>
        public  async Task<JObject> GetChatroomMemberList(string appId, string chatroomId)
        {
            JObject param = new JObject();
            param["appId"] = appId;
            param["chatroomId"] = chatroomId;
            return await okhttpUtil.PostJsonAsync("/group/getChatroomMemberList", param);
        }
        /// <summary>
        ///  获取群成员详情
        /// </summary>
        ...
        /// <returns></returns>
        public  async Task<JObject> GetChatroomMemberDetail(string appId, string chatroomId, List<string> memberWxids)
        {
            JObject param = new JObject();
            param["appId"] = appId;
            param["memberWxids"] = JArray.FromObject(memberWxids);
            param["chatroomId"] = chatroomId;
            return await okhttpUtil.PostJsonAsync("/group/getChatroomMemberDetail", param);
        }
        /// <summary>
        ///  获取群公告
        /// </summary>
        ...
        /// <param name="chatroomId"></param>
        /// <returns></returns>
        public  async Task<JObject> GetChatroomQrCode(string appId, string chatroomId)
        {
            JObject param = new JObject();
            param["appId"] = appId;
            param["chatroomId"] = chatroomId;
            return await okhttpUtil.PostJsonAsync("/group/getChatroomQrCode", param);
        }
        /// <summary>
        /// 群保存到通讯录
        /// </summary>
